...
namespace ScrummersSalesApi.Backend.Products.Api.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        /// <summary>
        /// Gets a list of products by their Ids (Dapper). Includes stock info.
        /// POST /Products/ByIds
        /// Body: ["guid1","guid2",...]
        /// </summary>
        [HttpPost("ByIds")]
        public Task<IEnumerable<ProductDto>> GetByIds([FromBody] IReadOnlyList<Guid> ids)
            => _mediator.Send(new GetProductsByIdsQuery(ids));
