...
using ScrummersSalesApi.Backend.Products.Domain.Commons.Exception;
...
namespace ScrummersSalesApi.Backend.Products.Infrastructure.Adapters
{
        ...
        where E : DomainEntity
    {
        ...
        public GenericRepository(ProductsDbContext productsContext)
        {
